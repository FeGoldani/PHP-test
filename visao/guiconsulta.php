					...
					<div class="row">
						<div class="3u">
							<section id="sidebar1">
								<header>
									<h2>Sidebar 1</h2>
								<h2><a href="../index.html" title="Exemplo PHP">Exemplo PHP</a></h2>
						<nav class="group">
...
<p>
        <h2><strong><span class="green">Usuários cadastrados:</span></strong></h2>	
	<div>
	  <ol>
	    <li>
	      <?php
		...
		<table summary="Tabela de usuários" border="1">
			...
			<tbody>
				<?php
				//imprimindo o toString do objeto
				foreach($usu as $u){
					echo '<tr>';
				
				echo"<td><a href='../controle/usuariocontrole.php?op=deletar&email=$u->email'> $u->email</a></td>";
				echo'<td>'.$u->nome.'</td>';
				echo'<td>'.$u->tel.'</td>';
				echo'<td>'.$u->tipo.'</td>';
		...
		<?php
				...
				echo 'Variável usuarios não existe';
			}//fecha else isset
		?>
    <br>
    <br>
